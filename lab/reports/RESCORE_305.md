...
_141 configs re-priced (cross-sectional campaign, 1d + 3d). Job still finishing the last 3d configs in the background; the pattern below is stable._

Only the cost number changed (per-coin cost_model, REPRICING_RULE frozen). Signals, params, universe, dates, trial count and DSR denominators unchanged.

- **gate-status changes: 0**
- net Sharpe worse under v2: 134
- net Sharpe better under v2: 0
- mean Δ net Sharpe (v2−v1): -0.132   median -0.110

## Gate-status changes

_none_

## Per-family summary (best config each)

| family | horizon | best v1 netSR | best v2 netSR | Δ | v1 gate | v2 gate |
|---|---|---|---|---|---|---|
...
| family | mechanism | h | cfg | v1 netSR | v2 netSR | Δ | v1→v2 gate |
|---|---|---|---|---|---|---|---|
